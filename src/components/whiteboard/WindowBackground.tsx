...
export const WindowBackground = React.memo(({ vistaUrl, brainTheme, isMobile, isTransitioning }: WindowBackgroundProps) => {
  return (
    <div className="whiteboard-background" aria-hidden>
      ...
      <div 
        ...
        style={{
          ...
          filter: isTransitioning ? 'none' : (brainTheme === 'dark' 
